...
wandb.init(project="first_MLops", name="intro_pickle_artifact_wanb_config")  
...
artifact_original=wandb.Artifact(name="random_forest_model", type="model")
artifact_original.add_file(model_filename)
